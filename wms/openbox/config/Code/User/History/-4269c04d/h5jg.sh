...
echo $line
echo -e '----- Preparando o sistema...' 
echo -e $line ""
sleep 3
echo -e "Instalando pacotes essenciais...\n"
#sudo apt install software-properties-common git vim build-essential curl
echo -e "Adicionando \e[33;1mnon-free\e[m no arquivo de repositórios\n"
#sudo apt-add-repository non-free
echo -e "Adicionando \e[33;1mcontrib\e[m no arquivo de repositórios\n"
